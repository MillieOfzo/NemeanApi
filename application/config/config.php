...
if (file_exists(APPPATH . 'config/app-config.php')) {
    ...
    $install_url .= 'install';
    echo '<h1>Nemean CRM</h1>';
    echo '<p>1. To you use the automatic Nemean CRM installation tool click <a href="' . $install_url . '">here (' . $install_url . ')</a></p>';
...
$config['csrf_exclude_uris'] = ['forms/wtl/[0-9a-z]+', 'api/[0-9a-z]+'];
...
if ($config['csrf_protection'] == true && isset($_SERVER['REQUEST_URI']) && strpos($_SERVER['REQUEST_URI'], 'gateways/') !== false && strpos($_SERVER['REQUEST_URI'], 'api/') !== false) {
